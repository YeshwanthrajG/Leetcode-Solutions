...
Statement : You are given an array of positive integers arr. Perform some operations (possibly none) on 
...
abs(arr[i] - arr[i - 1]) <= 1 for each i where 1 <= i < arr.length (0-indexed). abs(x) is the absolute 
value of x.
