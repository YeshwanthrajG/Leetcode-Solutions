...
Statement : You are given an integer mass, which represents the original mass of a planet. You are 
...
planet is greater than or equal to the mass of the asteroid, the asteroid is destroyed and the planet 
