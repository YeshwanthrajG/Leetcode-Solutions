...
Statement : On a 2D plane, there are n points with integer coordinates points[i] = [xi, yi]. 
...
/* Problem Link
https://leetcode.com/problems/minimum-time-visiting-all-points/description/?envType=daily-question&envId=2026-01-13
*/
